...
class ThemeConfig{
  ...
  static const Color darkThemeColor = Color.fromRGBO(33, 43, 54, 1);
  static const Color lightThemeColor = Color.fromRGBO(237, 248, 234, 1);
  static const Color  accentColor= Color.fromRGBO(2, 180, 173,1);// main theme color
  static Color lightAccentColor=const Color.fromRGBO(2, 180, 173,0.3);// main theme color
  static Color xLightAccentColor=const Color.fromRGBO(2, 180, 173,0.1);// main theme color
...
//Optional Color
  ...
  static Color background=const Color.fromRGBO(255, 255, 255, 1.0);
  static Color surface=const Color.fromRGBO(201, 201, 201, 1.0);
  static Color onSurface= ThemeConfig.fontColor;
  ...
  static Color transparentGrey = Color.fromRGBO(153,153,153, 0.5);
